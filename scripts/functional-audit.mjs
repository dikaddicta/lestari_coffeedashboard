...
record(appConfig.version === "40.0.0", "Application version is 40.0.0", String(appConfig.version || "missing"));
...
record(read("sw.js").includes("coffee-brew-os-v40-recommendation-qa"), "Service-worker cache name matches v40 release");
...
fs.writeFileSync(path.join(root, "docs/V40_AUDIT_RESULT.json"), JSON.stringify(report, null, 2));
