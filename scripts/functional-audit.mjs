...
record(appConfig.version === "44.0.0-rc.2", "Application version is 44.0.0-rc.2", String(appConfig.version || "missing"));
...
record(read("sw.js").includes("coffee-brew-os-v44-rc2"), "Service-worker cache name matches v44 release candidate");
